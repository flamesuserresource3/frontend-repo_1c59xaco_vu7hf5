  ...
  return (
    <section id="contact" className="relative py-20 sm:py-24">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <motion.div
          className="relative overflow-hidden rounded-3xl border border-black/5 dark:border-white/10 bg-neutral-900 text-white dark:bg-neutral-900"
          ...
          <div className="grid lg:grid-cols-2">
            <div className="p-8 sm:p-12">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/15 px-3 py-1 text-xs text-white/80">
                <ShieldCheck size={14} />
                Security-first, month-to-month
              </div>
              <h3 className="mt-4 text-2xl md:text-4xl font-bold">Bring AI to the bright side</h3>
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <a href="mailto:aryansingh8117@gmail.com" className="inline-flex items-center justify-center rounded-lg bg-white text-neutral-900 px-6 py-3 font-medium shadow hover:opacity-90 transition">
                  aryansingh8117@gmail.com
                  <ArrowRight size={18} className="ml-2" />
                </a>
                <a href="tel:+919315692224" className="inline-flex items-center justify-center rounded-lg border border-white/20 px-6 py-3 font-medium text-white hover:bg-white/10 transition">
                  <Phone size={18} className="mr-2" />
                  +91 93156 92224
                </a>
              </div>
              <p className="mt-3 text-xs text-neutral-400">Average kickoff in 7 days. Pilot in 2–4 weeks with measurable KPIs.</p>
            </div>
